const BASE_URL ="https://raw.githubusercontent.com/TheArmagan/currency/main/api/";
...
btn.addEventListener("click", async (evt) => {
    ...
    const URL = `${BASE_URL}/${fromcurr.value.toUpperCase()}-to-${tocurr.value.toUpperCase()}.json`;
   try {
